	...
	<div class="main-content" style="width:1600px; height:800px; overflow:scroll;">
		...
		<div class="sticky-header header-section ">
			<div class="header-left">
				<!--logo -->
				<div class="logo">
					<a onclick="window.location.href='index.jsp'">
					<h1>FoodMart</h1></a>
				</div>
				<!--//logo-->
        ...
        <form name="form-sales" method='POST' action='/BI-OLAP/WarehouseServlet' >
		<div id="page-wrapper">
			<div class="main-page">
				...
				<div class="bs-docs-example" >
				  ...
				  <!-- checkbox value可以改动 -->
				    <label>
					<input name=chk1 value=m1 type=checkbox id=m1 checked="true">Warehouse Sales &nbsp
					<input name=chk1 value=m2 type=checkbox id=m2 checked="true">Warehouse Cost  &nbsp
					<input name=chk1 value=m3 type=checkbox id=m3 checked="true">Supply Time  &nbsp
					</label>
					...
					<tr>
						<td>
                             ...
                             <div class="wrapper bg-white b-b">                              
                               <br>
                                    <label>
                                      <input name=chk2 value="d1" type=checkbox id=d1 checked="true">Warehouse Dim  &nbsp   
                                      <input name=chk2 value="d3" type=checkbox id=d3 checked="true">Store Dim      &nbsp
                                      <input name=chk2 value="d4" type=checkbox id=d4 checked="true">Promotion Dim   &nbsp                                       <input name=chk2 value="d5" type=checkbox id=d5 checked="true">Time Dim        &nbsp&nbsp&nbsp&nbsp&nbsp
